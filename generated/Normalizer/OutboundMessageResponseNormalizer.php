...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class OutboundMessageResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        use CheckArray;
        ...
        {
            return 'TouchSms\\ApiClient\\Api\\Model\\OutboundMessageResponse' === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return \is_object($data) && 'TouchSms\\ApiClient\\Api\\Model\\OutboundMessageResponse' === \get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \TouchSms\ApiClient\Api\Model\OutboundMessageResponse();
            ...
            if (\array_key_exists('meta', $data) && null !== $data['meta']) {
                $object->setMeta($this->denormalizer->denormalize($data['meta'], 'TouchSms\\ApiClient\\Api\\Model\\OutboundMessageResponseMeta', 'json', $context));
                unset($data['meta']);
        ...
        {
            return ['TouchSms\\ApiClient\\Api\\Model\\OutboundMessageResponse' => false];
        }
    }
} else {
    class OutboundMessageResponseNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
