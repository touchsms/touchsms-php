...
if (!class_exists(Kernel::class) || (Kernel::MAJOR_VERSION >= 7 || Kernel::MAJOR_VERSION === 6 && Kernel::MINOR_VERSION === 4)) {
    class V2SmsPostResponse200DataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
    {
        use CheckArray;
        ...
        {
            return 'TouchSms\\ApiClient\\Api\\Model\\V2SmsPostResponse200Data' === $type;
        }

        public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
        {
            return \is_object($data) && 'TouchSms\\ApiClient\\Api\\Model\\V2SmsPostResponse200Data' === \get_class($data);
        }
        ...
        public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
        {
            ...
            $object = new \TouchSms\ApiClient\Api\Model\V2SmsPostResponse200Data();
        ...
        {
            return ['TouchSms\\ApiClient\\Api\\Model\\V2SmsPostResponse200Data' => false];
        }
    }
} else {
    class V2SmsPostResponse200DataNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
