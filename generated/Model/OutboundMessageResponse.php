...
class OutboundMessageResponse extends \ArrayObject
{
    /**
     * @var array
     */
    ...
    protected $date;
    /**
     * @var OutboundMessageResponseMeta|null
     */
    protected $meta;
    ...
    public function getMeta(): ?OutboundMessageResponseMeta
    {
        return $this->meta;
    }

    public function setMeta(?OutboundMessageResponseMeta $meta): self
    {
